...
- [vue-a11y-dialog](https://github.com/morkro/vue-a11y-dialog)-用于可访问对话框[`a11y-dialog`](<https://github.com的Vue.js>组件包装器。 com / edenspiekermann / a11y-dialog)。
...
- [vue-draggable-nested-tree](https://github.com/phphe/vue-draggable-nested-tree)-适用于 Vuejs2 [@phphe](<https://github.com>的功能强大的可自定义可拖动树视图组件。 com / phphe)
